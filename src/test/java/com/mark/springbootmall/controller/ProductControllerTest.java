...
public class ProductControllerTest {
    ...
    public void getProduct_success() throws Exception {
        ...
        mockMvc.perform(requestBuilder)
                .andDo(print()) //運行的時候在下面的 console 印出這個 api 的返回結果
    ...
    public void getProducts() throws Exception {
        ...
        mockMvc.perform(requestBuilder)
                ...
                .andExpect(jsonPath("$.results", hasSize(5)));//results是List可以用 hasSize(預期返回幾筆數據)
    }
    ...
    public void getProducts_filtering() throws Exception {
        ...
        //預期當查詢商品的關鍵字是 B且分類是CAR 時只會去找到 2 筆的商品數據
    }
    ...
    public void getProducts_sorting() throws Exception {
        ...
        //也可以用List 一筆一筆的去取得 results 裡面的商品數據
        //在 results 的第一個商品數據他的 product id 的值是否為 6
    }
